...
export default async function CajaPage() {
    ...
    if (!cajaAbierta) {
        ...
        <div className="max-w-md px-8 py-7">
            ...
            No tenés una caja abierta. Contá el efectivo del cajón y abrí tu turno.
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="rounded-lg border border-border bg-card p-5">
                ...
                <div>
                    ...
                    <span className="tabular">{pesos(cajaAbierta.montoApertura, 0)}</span>
                </div>
                <div>
                    <span className="text-muted-foreground">Entró </span>
                    <span className="tabular text-success">+{pesos(ingresos, 0)}</span>
                </div>
                <div>
                    <span className="text-muted-foreground">Salió </span>
                    <span className="tabular text-danger">−{pesos(egresos, 0)}</span>
                </div>
                </div>
            </div>
